          ...
          child: Column(
            ...
            children: [
              const Text(
                ...
                style: TextStyle(
                    fontSize: 20,
                    color: Color.fromARGB(255, 86, 94, 93),
              ...
              TextField(
                  ...
                  decoration: InputDecoration(
                    border: const OutlineInputBorder(),
                    hintText: 'Enter Order & place you order',
                    labelText: 'Order Details & Place',
                    errorText: _validateDescription
                        ? 'Order & Place Value Can\'t Be Empty'
                        : null,
                  )),
              const SizedBox(
                height: 20.0,
                ...
                children: [
                  TextButton(
                      style: TextButton.styleFrom(
                          ...
                          backgroundColor:Color.fromARGB(255, 48, 95, 70),
                  ...
                  TextButton(
                      style: TextButton.styleFrom(
                          ...
                          backgroundColor:  Color.fromARGB(212, 231, 244, 54),
                          textStyle: const TextStyle(fontSize: 15)),
                      onPressed: () {
