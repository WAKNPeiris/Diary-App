        ...
        builder: (param) {
          return AlertDialog(
            title: const Text(
              ...
              style: TextStyle(
                  color: Color.fromARGB(255, 58, 66, 65), fontSize: 20),
            ),
            actions: [
              TextButton(
                  ...
                  onPressed: () async {
                    ...
                    if (result != null) {
                      ...
                      getAllUserDetails();
                      _showSuccessSnackBar('Order Detail Deleted Success');
                    }
                  },
          ...
          itemBuilder: (context, index) {
            return Card(
              child: ListTile(
                ...
                subtitle: Text(_userList[index].description ?? ''),
                trailing: Row(
                  ...
                  children: [
                    IconButton(
                        ...
                        icon: const Icon(
                          Icons.edit,
                          color: Color.fromARGB(255, 85, 217, 89),
                        )),
                    IconButton(
                        onPressed: () {
                        ...
                        icon: const Icon(
                          Icons.delete,
                          color: Color.fromARGB(255, 170, 12, 1),
                        ))
                  ],
                ),
              ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(context,
            ...
            if (data != null) {
              getAllUserDetails();
              _showSuccessSnackBar('Order Detail Added Success');
            }
          });
        },
